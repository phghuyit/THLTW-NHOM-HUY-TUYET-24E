CREATE DATABASE IF NOT EXISTS `thltweb_huy_tuyet` CHARACTER
SET
...
CREATE TABLE
    `products` (
        ...
        `rental_price_per_day` DECIMAL(12, 2) NOT NULL DEFAULT 0.00,
        `deposit_rate_percent` INT DEFAULT 70,
...
CREATE TABLE
    `orders` (
        ...
        `total_rental_fee` DECIMAL(12, 2) NOT NULL DEFAULT 0.00,
